...
import Models.se_module as se_module
...
def test_decoder():
    ...
    net = PIXOR(use_bn=False).cuda()
    # net.set_decode(True)
    preds = net(torch.autograd.Variable(torch.randn(2, 800, 700, 36).cuda()))
